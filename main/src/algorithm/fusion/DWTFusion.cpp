...
bool DWTFusion::MeanStd_DWT_HIS_Fusion(const char* Input_PAN_FileName, const char* Input_MS_FileName, const char* Output_MS_FileName,const char* LogName,int* bandlist,int InterpolationMethod){
    /*
     *融合方法：DWT与HSI
     *替换规则：I分量替换
