...
public:
    ...
    ::RPCQualityJudge::QualityInfo fetchQualityRes(const ::RPCQualityJudge::QualityInputStruct& inputArgs)
    {
        return fetchQualityRes(inputArgs, 0);
    }
    ::RPCQualityJudge::QualityInfo fetchQualityRes(const ::RPCQualityJudge::QualityInputStruct& inputArgs, const ::Ice::Context& __ctx)
    {
        return fetchQualityRes(inputArgs, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_fetchQualityRes(const ::RPCQualityJudge::QualityInputStruct& inputArgs, const ::IceInternal::Function<void (const ::RPCQualityJudge::QualityInfo&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_fetchQualityRes(inputArgs, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_fetchQualityRes(const ::RPCQualityJudge::QualityInputStruct& inputArgs, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_fetchQualityRes(inputArgs, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_fetchQualityRes(const ::RPCQualityJudge::QualityInputStruct& inputArgs, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::RPCQualityJudge::QualityInfo&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_fetchQualityRes(inputArgs, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_fetchQualityRes(const ::RPCQualityJudge::QualityInputStruct& inputArgs, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
...
private:
    ...
    ::Ice::AsyncResultPtr __begin_fetchQualityRes(const ::RPCQualityJudge::QualityInputStruct& inputArgs, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::RPCQualityJudge::QualityInfo&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent)
    {
        class Cpp11CB : public ::IceInternal::Cpp11FnCallbackNC
        {
        public:
...
public:
    ...
    ::Ice::AsyncResultPtr begin_fetchQualityRes(const ::RPCQualityJudge::QualityInputStruct& inputArgs)
    {
        return begin_fetchQualityRes(inputArgs, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_fetchQualityRes(const ::RPCQualityJudge::QualityInputStruct& inputArgs, const ::Ice::Context& __ctx)
    {
        return begin_fetchQualityRes(inputArgs, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_fetchQualityRes(const ::RPCQualityJudge::QualityInputStruct& inputArgs, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_fetchQualityRes(inputArgs, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_fetchQualityRes(const ::RPCQualityJudge::QualityInputStruct& inputArgs, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_fetchQualityRes(inputArgs, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_fetchQualityRes(const ::RPCQualityJudge::QualityInputStruct& inputArgs, const ::RPCQualityJudge::Callback_QualityInf_fetchQualityResPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_fetchQualityRes(inputArgs, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_fetchQualityRes(const ::RPCQualityJudge::QualityInputStruct& inputArgs, const ::Ice::Context& __ctx, const ::RPCQualityJudge::Callback_QualityInf_fetchQualityResPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_fetchQualityRes(inputArgs, &__ctx, __del, __cookie);
    }
...
public:
    ...
    virtual ::RPCQualityJudge::QualityInfo fetchQualityRes(const ::RPCQualityJudge::QualityInputStruct&, const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;
};
...
public:
    ...
    virtual ::RPCQualityJudge::QualityInfo fetchQualityRes(const ::RPCQualityJudge::QualityInputStruct&, const ::Ice::Context*, ::IceInternal::InvocationObserver&);
};
