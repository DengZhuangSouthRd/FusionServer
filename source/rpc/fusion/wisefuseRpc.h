...
public:
    ...
    {
        return fuseSyn(__p_mapArgs, 0);
    }
    ::RPCWiseFuse::FusionInf fuseSyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context& __ctx)
    {
        return fuseSyn(__p_mapArgs, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_fuseSyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::IceInternal::Function<void (const ::RPCWiseFuse::FusionInf&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_fuseSyn(__p_mapArgs, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_fuseSyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_fuseSyn(__p_mapArgs, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_fuseSyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::RPCWiseFuse::FusionInf&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_fuseSyn(__p_mapArgs, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_fuseSyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_fuseSyn(__p_mapArgs, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_fuseSyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::RPCWiseFuse::FusionInf&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent);
    
public:
#endif

    ::Ice::AsyncResultPtr begin_fuseSyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs)
    {
        return begin_fuseSyn(__p_mapArgs, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_fuseSyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context& __ctx)
    {
        return begin_fuseSyn(__p_mapArgs, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_fuseSyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_fuseSyn(__p_mapArgs, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_fuseSyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_fuseSyn(__p_mapArgs, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_fuseSyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::RPCWiseFuse::Callback_WiseFusionInf_fuseSynPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_fuseSyn(__p_mapArgs, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_fuseSyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context& __ctx, const ::RPCWiseFuse::Callback_WiseFusionInf_fuseSynPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_fuseSyn(__p_mapArgs, &__ctx, __del, __cookie);
    }
...
public:
    ...
    ::Ice::Int fuseAsyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs)
    {
        return fuseAsyn(__p_mapArgs, 0);
    }
    ::Ice::Int fuseAsyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context& __ctx)
    {
        return fuseAsyn(__p_mapArgs, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_fuseAsyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::IceInternal::Function<void (::Ice::Int)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_fuseAsyn(__p_mapArgs, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_fuseAsyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_fuseAsyn(__p_mapArgs, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_fuseAsyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (::Ice::Int)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_fuseAsyn(__p_mapArgs, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_fuseAsyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_fuseAsyn(__p_mapArgs, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_fuseAsyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (::Ice::Int)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent);
    
public:
#endif

    ::Ice::AsyncResultPtr begin_fuseAsyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs)
    {
        return begin_fuseAsyn(__p_mapArgs, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_fuseAsyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context& __ctx)
    {
        return begin_fuseAsyn(__p_mapArgs, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_fuseAsyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_fuseAsyn(__p_mapArgs, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_fuseAsyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_fuseAsyn(__p_mapArgs, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_fuseAsyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::RPCWiseFuse::Callback_WiseFusionInf_fuseAsynPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_fuseAsyn(__p_mapArgs, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_fuseAsyn(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context& __ctx, const ::RPCWiseFuse::Callback_WiseFusionInf_fuseAsynPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_fuseAsyn(__p_mapArgs, &__ctx, __del, __cookie);
    }
...
public:
    ...
    ::std::string askProcess(const ::RPCWiseFuse::DirArgs& __p_mapArgs)
    {
        return askProcess(__p_mapArgs, 0);
    }
    ::std::string askProcess(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context& __ctx)
    {
        return askProcess(__p_mapArgs, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_askProcess(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::IceInternal::Function<void (const ::std::string&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_askProcess(__p_mapArgs, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_askProcess(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_askProcess(__p_mapArgs, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_askProcess(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::std::string&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_askProcess(__p_mapArgs, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_askProcess(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_askProcess(__p_mapArgs, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_askProcess(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::std::string&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent);
    
public:
#endif

    ::Ice::AsyncResultPtr begin_askProcess(const ::RPCWiseFuse::DirArgs& __p_mapArgs)
    {
        return begin_askProcess(__p_mapArgs, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_askProcess(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context& __ctx)
    {
        return begin_askProcess(__p_mapArgs, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_askProcess(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_askProcess(__p_mapArgs, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_askProcess(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_askProcess(__p_mapArgs, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_askProcess(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::RPCWiseFuse::Callback_WiseFusionInf_askProcessPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_askProcess(__p_mapArgs, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_askProcess(const ::RPCWiseFuse::DirArgs& __p_mapArgs, const ::Ice::Context& __ctx, const ::RPCWiseFuse::Callback_WiseFusionInf_askProcessPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_askProcess(__p_mapArgs, &__ctx, __del, __cookie);
    }
...
public:
    ...
    ::RPCWiseFuse::FusionInf fetchFuseRes(const ::RPCWiseFuse::DirArgs& __p_mapArg)
    {
        return fetchFuseRes(__p_mapArg, 0);
    }
    ::RPCWiseFuse::FusionInf fetchFuseRes(const ::RPCWiseFuse::DirArgs& __p_mapArg, const ::Ice::Context& __ctx)
    {
        return fetchFuseRes(__p_mapArg, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_fetchFuseRes(const ::RPCWiseFuse::DirArgs& __p_mapArg, const ::IceInternal::Function<void (const ::RPCWiseFuse::FusionInf&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_fetchFuseRes(__p_mapArg, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_fetchFuseRes(const ::RPCWiseFuse::DirArgs& __p_mapArg, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_fetchFuseRes(__p_mapArg, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_fetchFuseRes(const ::RPCWiseFuse::DirArgs& __p_mapArg, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::RPCWiseFuse::FusionInf&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_fetchFuseRes(__p_mapArg, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_fetchFuseRes(const ::RPCWiseFuse::DirArgs& __p_mapArg, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_fetchFuseRes(__p_mapArg, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_fetchFuseRes(const ::RPCWiseFuse::DirArgs& __p_mapArg, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::RPCWiseFuse::FusionInf&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent);
    
public:
#endif

    ::Ice::AsyncResultPtr begin_fetchFuseRes(const ::RPCWiseFuse::DirArgs& __p_mapArg)
    {
        return begin_fetchFuseRes(__p_mapArg, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_fetchFuseRes(const ::RPCWiseFuse::DirArgs& __p_mapArg, const ::Ice::Context& __ctx)
    {
        return begin_fetchFuseRes(__p_mapArg, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_fetchFuseRes(const ::RPCWiseFuse::DirArgs& __p_mapArg, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_fetchFuseRes(__p_mapArg, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_fetchFuseRes(const ::RPCWiseFuse::DirArgs& __p_mapArg, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_fetchFuseRes(__p_mapArg, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_fetchFuseRes(const ::RPCWiseFuse::DirArgs& __p_mapArg, const ::RPCWiseFuse::Callback_WiseFusionInf_fetchFuseResPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_fetchFuseRes(__p_mapArg, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_fetchFuseRes(const ::RPCWiseFuse::DirArgs& __p_mapArg, const ::Ice::Context& __ctx, const ::RPCWiseFuse::Callback_WiseFusionInf_fetchFuseResPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_fetchFuseRes(__p_mapArg, &__ctx, __del, __cookie);
    }
...
public:
    ...
    ::IceInternal::ProxyHandle<WiseFusionInf> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<WiseFusionInf*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
